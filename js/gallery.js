...
function lightboxContent(photo) {
    return (
        '<button type="button" class="lightbox-close lb-close" aria-label="Galeriye dön">' +
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/><path d="M9 12h11"/></svg></button>' +
